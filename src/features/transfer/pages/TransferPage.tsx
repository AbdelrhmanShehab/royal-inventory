...
interface TransferPageProps {
  defaultTab?: 'all' | 'incoming' | 'outgoing';
}
...
export default function TransferPage({ defaultTab = 'all' }: TransferPageProps) {
  ...
  const [activeTab, setActiveTab] = useState<'all' | 'incoming' | 'outgoing'>(defaultTab);
          ...
          <div className="flex gap-2">
            <PermissionGate permission={TRANSFER_PERMISSIONS.CREATE_DRAFT}>
              <Button 
                ...
                className="gap-2 shadow-xs bg-blue-600 hover:bg-blue-700"
              >
                <Plus size={15} />
